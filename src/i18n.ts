...
const DICT = {
  ...
  addCutoffHint: {
    de: 'Tippe eine Staffel/einen Film an, um sie als geschaut zu markieren. Über die Schere an einer Kachel schneidest du das Franchise dort ab — alles danach zählt nicht mehr zum Eintrag.',
    en: 'Tap a season/movie to mark it watched. Use the scissors on a tile to cut the franchise there — everything after no longer counts toward the entry.',
  },
