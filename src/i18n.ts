...
const DICT = {
  ...
  // Status
  stWatching: { de: 'Weiter schauen', en: 'Watching' },
  ...
  sequelShort: { de: 'Fortsetzung', en: 'Sequel' },
  sequelBadge: { de: 'Fortsetzung folgt', en: 'Sequel coming' },
  ...
  continueWithEp: { de: 'Weiter mit Ep. {n}', en: 'Continue with ep. {n}' },
  ...
  rowTrending: { de: 'Gerade im Trend', en: 'Trending now' },
  rowSeason: { de: 'Diese Season', en: 'This season' },
  rowUpcoming: { de: 'Bald verfügbar', en: 'Coming soon' },
  rowTop: { de: 'Bestbewertet', en: 'Top rated' },
  rowMovies: { de: 'Filme', en: 'Movies' },
  viewDetails: { de: 'Ansehen', en: 'View' },
  ...
  searchHits: { de: '{n} Treffer', en: '{n} results' },
  ...
  addCutoffHint: {
    de: 'Tippe eine Staffel/einen Film an, um sie als geschaut zu markieren. Mit der Schere legst du fest, wo dein Franchise endet — die angetippte Kachel bleibt inklusive drin, nur alles danach zählt nicht mehr zum Eintrag.',
    en: 'Tap a season/movie to mark it watched. Use the scissors to set where your franchise ends — that tile is kept (inclusive), only everything after no longer counts toward the entry.',
  },
  addCutoffToggle: { de: 'Hier abschneiden', en: 'Cut off here' },
  addCutoffActive: { de: 'Franchise endet bei „{t}“ — inklusive', en: 'Franchise ends at “{t}” — included' },
  addCutoffEndsHere: { de: 'Endet hier', en: 'Ends here' },
  ...
  removeRowTitle: { de: 'Aus der Bibliothek entfernen', en: 'Remove from library' },
  removeRowSub: {
  ...
  continuationComingSoon: {
    de: 'Angekündigt, aber noch nicht da — die Einträge bleiben gedämpft, bis es losgeht.',
    en: 'Announced but not out yet — these entries stay dimmed until they start.',
  },
  randomPickBtn: { de: 'Für mich entscheiden', en: 'Pick for me' },
  randomPickCta: { de: 'Jetzt ansehen', en: 'View now' },
  rollAgain: { de: 'Nochmal', en: 'Again' },
  progressLabel: { de: 'Fortschritt', en: 'Progress' },
  episodeXofY: { de: 'Episode {p} von {t}', en: 'Episode {p} of {t}' },
  detFranchiseEpisodes: {
    de: '{n} Episoden im ganzen Franchise gesehen',
    en: '{n} episodes watched across the whole franchise',
  },
  cardFilmWaits: { de: 'Film wartet', en: 'Movie waiting' },
  cardSeasonWaits: { de: 'Staffel {n} wartet', en: 'Season {n} waiting' },
  ratingNone: { de: 'ohne Wertung', en: 'no rating' },
  bookmarked: { de: 'Vorgemerkt', en: 'Bookmarked' },
  dateUnknown: { de: 'Datum unbekannt', en: 'Date unknown' },
  ...
  rewatchBtn: { de: 'Nochmal schauen', en: 'Watch again' },
  changeStatusBtn: { de: 'Status ändern', en: 'Change status' },
  ...
  statsTitles: { de: 'Einträge', en: 'Entries' },
  statsEpisodes: { de: 'Episoden', en: 'Episodes' },
  ...
  statsAvgRating: { de: 'Ø Wertung', en: 'Avg. rating' },
  statsByStatus: { de: 'Wie sich dein Archiv verteilt', en: 'How your archive breaks down' },
  statsGenres: { de: 'Genres', en: 'Genres' },
  statsRatingDist: { de: 'Wie du wertest', en: 'How you rate' },
  statsByYear: { de: 'Nach Erscheinungsjahr', en: 'By release year' },

  // Einstellungen
  settingsTitle: { de: 'Einstellungen', en: 'Settings' },
  settingsSubShort: { de: 'Konto, Sprache, Sicherung.', en: 'Account, language, backup.' },
  settingsSub: {
  ...
  profileTitle: { de: 'Profil', en: 'Profile' },
  profileLabel: { de: 'Dein Name', en: 'Your name' },
  profilePlaceholder: { de: 'Wie sollen wir dich nennen?', en: 'What should we call you?' },
  profileSaveBtn: { de: 'Speichern', en: 'Save' },
  profileChangeNote: {
    de: 'Kann alle 7 Tage einmal geändert werden.',
    en: 'Can be changed once every 7 days.',
  },
  profileLockedHint: {
    de: 'Du heißt „{name}“ — die nächste Änderung ist in {days} Tag(en) möglich.',
    en: 'You’re “{name}” — you can change this again in {days} day(s).',
  },
  profileSavedToast: { de: 'Name gespeichert', en: 'Name saved' },
  ...
  backupTitle: { de: 'Sicherung', en: 'Backup' },
  backupText: {
  ...
  exportBtn: { de: 'Bibliothek exportieren', en: 'Export library' },
  exportRowSub: { de: '{n} Einträge als Datei', en: '{n} entries as a file' },
  importBtn: { de: 'Sicherung einspielen', en: 'Restore backup' },
  importRowSub: { de: 'Überschreibt die aktuelle Bibliothek', en: 'Overwrites the current library' },
  ...
  dangerText: {
    de: 'Löscht alle Einträge unwiderruflich',
    en: 'Permanently deletes all entries',
  },
  wipeBtn: { de: 'Bibliothek leeren', en: 'Wipe library' },
  wipeConfirm: {
  ...
  moreFilters: { de: 'Mehr Filter', en: 'More filters' },
  showAllInLibrary: {
  ...
  // Formate
  fmtTV: { de: 'TV', en: 'TV' },
  fmtTVShort: { de: 'TV-Kurz', en: 'TV short' },
  ...
  detEpisodesShort: { de: '{n} Folgen', en: '{n} episodes' },
  communityScorePct: { de: '{n} % Community', en: '{n}% community' },
  detAirDate: { de: 'Erstausstrahlung', en: 'First aired' },
  detEpisodesLabel: { de: 'Folgen', en: 'Episodes' },
  detRuntime: { de: 'Laufzeit', en: 'Runtime' },
  detAirStatus: { de: 'Status', en: 'Status' },
