    ...
    <div ref={rootRef} className="flex flex-wrap items-center gap-2">
      ...
      {actions.map((a) => (
        <button
          ...
          type="button"
          onClick={a.onClick}
          className={`press inline-flex shrink-0 items-center gap-2 rounded-ctl border border-line bg-surface px-4 py-2.5 text-sm font-semibold text-ink transition-colors duration-150 ${a.hoverCls}`}
        >
      ...
      <button
        ...
        className="press inline-flex shrink-0 items-center justify-center rounded-ctl border border-line bg-surface p-2.5 text-ink-faint transition-colors duration-150 hover:text-rose"
      >
