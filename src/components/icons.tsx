...
/**
 * TSUGI V5 — Zeichensatz als Paare.
 *   o = Kontur  → inaktiv, 2px Strich
 *   f = gefüllt → aktiv, massive Fläche
 * Innenzeichnung gefüllter Symbole wird in --knock ausgestanzt (Trägerfarbe).
 * 1:1 aus design-lab/v5-nativ/icons.js.
 */

type Paths = { o: string; f?: string };
...
const P: Record<string, Paths> = {
  ...
  home: {
    ...
    // Tür exakt mittig (10..14, Mitte 12) — als Aussparung in --knock, damit sie
    // nicht am rechten Rand der Silhouette klebt.
    f: '<path d="M11.38 3.3a1 1 0 0 1 1.24 0l8.6 6.72a1 1 0 0 1 .38.79V19a2.4 2.4 0 0 1-2.4 2.4H4.8A2.4 2.4 0 0 1 2.4 19v-8.19a1 1 0 0 1 .38-.79Z"/><path d="M10 21v-6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v6Z" fill="var(--knock, #0d0f18)"/>',
  },
  compass: {
    o: '<circle cx="12" cy="12" r="8.6"/><path d="m15.4 8.6-1.9 4.9-4.9 1.9 1.9-4.9Z"/>',
    // Nadel um (-1.5, -0.7) verschoben, damit ihr Schwerpunkt auf dem
    // Kreismittelpunkt (12,12) liegt statt oben-rechts daneben.
    f: '<circle cx="12" cy="12" r="9"/><path d="m14.4 7.4-4.6 1.8a1 1 0 0 0-.57.57L7.4 14.4a.7.7 0 0 0 .9.9l4.63-1.79a1 1 0 0 0 .57-.57l1.79-4.63a.7.7 0 0 0-.9-.9Z" fill="var(--knock, #0d0f18)"/>',
  },
  stack: {
  ...
  // „Noch zu schauen" — Skip-forward, eindeutig „das kommt als Nächstes"
  // (das alte `ready` sah aus wie Download).
  next: {
    o: '<path d="M6 5.6v12.8a1 1 0 0 0 1.55.83l8.4-6.4a1 1 0 0 0 0-1.66l-8.4-6.4A1 1 0 0 0 6 5.6Z"/><path d="M18.6 4.8v14.4"/>',
    f: '<path d="M6 5.6v12.8a1 1 0 0 0 1.55.83l8.4-6.4a1 1 0 0 0 0-1.66l-8.4-6.4A1 1 0 0 0 6 5.6Z"/><rect x="17.4" y="4.6" width="2.6" height="14.8" rx="1.3"/>',
  },
  bookmark: {
  ...
  dots: {
    o: '<circle cx="5" cy="12" r="1.9" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.9" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.9" fill="currentColor" stroke="none"/>',
  },
  pause: {
    o: '<rect x="6.6" y="4.6" width="3.8" height="14.8" rx="1.9"/><rect x="13.6" y="4.6" width="3.8" height="14.8" rx="1.9"/>',
    f: '<rect x="6.6" y="4.6" width="3.8" height="14.8" rx="1.9"/><rect x="13.6" y="4.6" width="3.8" height="14.8" rx="1.9"/>',
  },
  star: {
  ...
  trash: {
    o: '<path d="M4.4 6.6h15.2"/><path d="M9.6 6.6V5.2a1.8 1.8 0 0 1 1.8-1.8h1.2a1.8 1.8 0 0 1 1.8 1.8v1.4"/><path d="M6.6 6.6 7.4 19a1.8 1.8 0 0 0 1.8 1.6h5.6a1.8 1.8 0 0 0 1.8-1.6l.8-12.4"/><path d="M10.4 10.4v6.4M13.6 10.4v6.4"/>',
  },
  ...
  globe: {
    o: '<circle cx="12" cy="12" r="8.6"/><path d="M3.4 12h17.2"/><path d="M12 3.4c2.3 2.5 3.5 5.4 3.5 8.6S14.3 18.1 12 20.6C9.7 18.1 8.5 15.2 8.5 12S9.7 5.9 12 3.4Z"/>',
  },
  exit: {
    o: '<path d="M14.6 7.2V5.8a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2v12.4a2 2 0 0 0 2 2h6.2a2 2 0 0 0 2-2v-1.4"/><path d="M9.6 12h10M16.4 8.6 19.8 12l-3.4 3.4"/>',
  },
  grip: {
    o: '<circle cx="9" cy="6.4" r="1.6" fill="currentColor" stroke="none"/><circle cx="15" cy="6.4" r="1.6" fill="currentColor" stroke="none"/><circle cx="9" cy="12" r="1.6" fill="currentColor" stroke="none"/><circle cx="15" cy="12" r="1.6" fill="currentColor" stroke="none"/><circle cx="9" cy="17.6" r="1.6" fill="currentColor" stroke="none"/><circle cx="15" cy="17.6" r="1.6" fill="currentColor" stroke="none"/>',
  },
  scissors: {
    o: '<circle cx="6.6" cy="6.4" r="2.6"/><circle cx="6.6" cy="17.6" r="2.6"/><path d="M8.8 8.2 20 17.2M20 6.8 8.8 15.8"/>',
  },
  bell: {
  ...
  info: {
    o: '<circle cx="12" cy="12" r="8.8"/><path d="M12 11v5.4"/><circle cx="12" cy="7.9" r="1.15" fill="currentColor" stroke="none"/>',
  },
  shuffle: {
    o: '<path d="M3.6 6.6h3.2c1.4 0 2.6.8 3.4 2l3.6 6.8c.8 1.2 2 2 3.4 2h3.2"/><path d="M3.6 17.4h3.2c1.4 0 2.6-.8 3.4-2"/><path d="M14.4 8.6c.8-1.2 2-2 3.4-2h3.2"/><path d="m17.8 3.6 3 3-3 3M17.8 14.4l3 3-3 3"/>',
  },
...
export const hasFilled = (name: IconName): boolean => Boolean(P[name]?.f);
...
export function Icon({ name, filled = false, size = 22, className = '', ...rest }: IconProps) {
  const def = P[name];
  ...
  return (
    <svg
      ...
      {...strokeProps}
      {...rest}
      dangerouslySetInnerHTML={{ __html: solid ? def.f! : def.o }}
    />
  );
}

/**
 * Kontur + Füllung übereinander (Tab-Leiste, Seitenschiene). `.ico-pair.is-on`
 * blendet die Füllung ein und lässt sie kurz überschwingen (theme.css).
 */
export function IconPair({
  ...
  return (
    <span
      ...
      style={{ ['--ico-size' as string]: `${size}px` }}
    >
      <Icon name={name} size={size} className="ico-o" />
      {P[name].f && <Icon name={name} size={size} filled className="ico-f" />}
    </span>
  );
}

/* -------------------------------------------------------------------------- */
/* Übergangs-Aliasse: die alten Einzel-Icon-Namen, damit noch nicht portierte
   Dateien weiter bauen. Nutzen jetzt die V5-Pfade. Sobald alles portiert ist,
   entfernen. */
type Legacy = Omit<SVGProps<SVGSVGElement>, 'name'>;
const legacy = (name: IconName, filled = false) => (p: Legacy) =>
  <Icon name={name} filled={filled} {...p} />;

export const IconHome = legacy('home');
export const IconCompass = legacy('compass');
export const IconStack = legacy('stack');
export const IconChart = legacy('chart');
export const IconGear = legacy('gear');
export const IconSearch = legacy('search');
export const IconPlus = legacy('plus');
export const IconMinus = legacy('minus');
export const IconCheck = legacy('check');
export const IconChevronLeft = legacy('left');
export const IconChevronDown = legacy('down');
export const IconStar = legacy('star');
export const IconX = legacy('x');
export const IconPlay = legacy('play', true);
export const IconCalendar = legacy('calendar');
export const IconDownload = legacy('download');
export const IconUpload = legacy('upload');
export const IconTrash = legacy('trash');
export const IconArrowRight = legacy('arrow');
export const IconPause = legacy('pause');
export const IconFilm = legacy('film');
export const IconSparkle = legacy('sparkle');
export const IconGrip = legacy('grip');
export const IconClock = legacy('clock');
export const IconScissors = legacy('scissors');
export const IconMore = legacy('dots');
export const IconDice = legacy('dice');
